...
public class CartesianLabeledPoint extends CartesianPoint {
	
	private String label;
	
	private Color labelColor;
	
	public CartesianLabeledPoint(Float x, Float y) {
		super(x, y);
	}

	public CartesianLabeledPoint(Float x, Float y, String label) {
		super(x, y);
		this.label = label;
	}
