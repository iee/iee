package org.eclipse.iee.math.symbolic.pad;
...
import org.eclipse.iee.math.symbolic.FileStorage;
...
public class SymbolicPad extends Pad implements Serializable {
	...
	protected SymbolicPad(String containerID) {
		super();
	...
	public static void setStorage(FileStorage fStorage) {
		SymbolicPad.fFileStorage = fStorage;
	}

	@Override
	public Pad copy() {
		SymbolicPad newPad = new SymbolicPad();
	...
	public void save() {
		SymbolicPad.fFileStorage.saveToFile(this);
	}

	@Override
	public void unsave() {
		SymbolicPad.fFileStorage.removeFile(getContainerID());
	}
