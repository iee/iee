...
public class MathBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements MathVisitor<T> {
	...
	@Override public T visitIntervalParameter(MathParser.IntervalParameterContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitValueParameter(MathParser.ValueParameterContext ctx) { return visitChildren(ctx); }
