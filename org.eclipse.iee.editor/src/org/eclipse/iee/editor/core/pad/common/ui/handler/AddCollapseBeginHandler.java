package org.eclipse.iee.editor.core.pad.common.ui.handler;
...
public class AddCollapseBeginHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		fPadEditor.createPad(new CollapseBeginPart());
		return null;
	}
