...
package org.eclipse.iee.translator.molex.mex.services;
...
@Singleton
public class MexGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class VariableAssignmentElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cVariableMathNameParserRuleCall_0_0 = (RuleCall)cVariableAssignment_0.eContents().get(0);
		...
		//MathName
		public RuleCall getVariableMathNameParserRuleCall_0_0() { return cVariableMathNameParserRuleCall_0_0; }
	...
	public class AdditionInBracketsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "AdditionInBrackets");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cAdditionAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cAdditionAdditionParserRuleCall_1_0 = (RuleCall)cAdditionAssignment_1.eContents().get(0);
		...
		//addition=Addition
		public Assignment getAdditionAssignment_1() { return cAdditionAssignment_1; }

		//Addition
		public RuleCall getAdditionAdditionParserRuleCall_1_0() { return cAdditionAdditionParserRuleCall_1_0; }
	...
	public class PrimaryElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cNameMathNameParserRuleCall_0_1_0 = (RuleCall)cNameAssignment_0_1.eContents().get(0);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		...
		private final Action cMatrixElementAction_3_0 = (Action)cGroup_3.eContents().get(0);
		private final Assignment cElementAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final RuleCall cElementMathNameParserRuleCall_3_1_0 = (RuleCall)cElementAssignment_3_1.eContents().get(0);
		...
		private final RuleCall cRowFormulaParserRuleCall_3_3_0 = (RuleCall)cRowAssignment_3_3.eContents().get(0);
		...
		private final RuleCall cColumnFormulaParserRuleCall_3_6_0 = (RuleCall)cColumnAssignment_3_6.eContents().get(0);
		...
		//MathName
		public RuleCall getNameMathNameParserRuleCall_0_1_0() { return cNameMathNameParserRuleCall_0_1_0; }
		...
		//{MatrixElement}
		public Action getMatrixElementAction_3_0() { return cMatrixElementAction_3_0; }

		//element=MathName
		public Assignment getElementAssignment_3_1() { return cElementAssignment_3_1; }

		//MathName
		public RuleCall getElementMathNameParserRuleCall_3_1_0() { return cElementMathNameParserRuleCall_3_1_0; }
		...
		//Formula
		public RuleCall getRowFormulaParserRuleCall_3_3_0() { return cRowFormulaParserRuleCall_3_3_0; }
		...
		//Formula
		public RuleCall getColumnFormulaParserRuleCall_3_6_0() { return cColumnFormulaParserRuleCall_3_6_0; }
		...
		//{InBrackets}
		public Action getInBracketsAction_4_0() { return cInBracketsAction_4_0; }

		//inBrackets=AdditionInBrackets
		public Assignment getInBracketsAssignment_4_1() { return cInBracketsAssignment_4_1; }
	...
	public class MatrixRowElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cElementsFormulaParserRuleCall_1_0_0 = (RuleCall)cElementsAssignment_1_0.eContents().get(0);
		private final Group cGroup_1_1 = (Group)cGroup_1.eContents().get(1);
		private final Keyword cCommaKeyword_1_1_0 = (Keyword)cGroup_1_1.eContents().get(0);
		private final Assignment cElementsAssignment_1_1_1 = (Assignment)cGroup_1_1.eContents().get(1);
		private final RuleCall cElementsFormulaParserRuleCall_1_1_1_0 = (RuleCall)cElementsAssignment_1_1_1.eContents().get(0);
		private final Keyword cCommaKeyword_1_2 = (Keyword)cGroup_1.eContents().get(2);
		private final Keyword cRightCurlyBracketKeyword_2 = (Keyword)cGroup.eContents().get(2);
		...
		//Formula
		public RuleCall getElementsFormulaParserRuleCall_1_0_0() { return cElementsFormulaParserRuleCall_1_0_0; }
		...
		//Formula
		public RuleCall getElementsFormulaParserRuleCall_1_1_1_0() { return cElementsFormulaParserRuleCall_1_1_1_0; }
	...
	public class MatrixAssignmentElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cVariableMathNameParserRuleCall_1_0 = (RuleCall)cVariableAssignment_1.eContents().get(0);
		...
		//MathName
		public RuleCall getVariableMathNameParserRuleCall_1_0() { return cVariableMathNameParserRuleCall_1_0; }
	...
	public class MatrixAdditionInBracketsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MatrixAdditionInBrackets");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cAdditionAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cAdditionMatrixAdditionParserRuleCall_1_0 = (RuleCall)cAdditionAssignment_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_2 = (Keyword)cGroup.eContents().get(2);
		...
		//MatrixAddition
		public RuleCall getAdditionMatrixAdditionParserRuleCall_1_0() { return cAdditionMatrixAdditionParserRuleCall_1_0; }
	...
	public class PrimaryMatrixElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cNameMathNameParserRuleCall_1_2_0 = (RuleCall)cNameAssignment_1_2.eContents().get(0);
		...
		private final RuleCall cNameMathNameParserRuleCall_2_2_0 = (RuleCall)cNameAssignment_2_2.eContents().get(0);
		...
		private final Group cGroup_4 = (Group)cAlternatives.eContents().get(4);
		private final Action cMatrixInBracketsAction_4_0 = (Action)cGroup_4.eContents().get(0);
		private final Assignment cInBracketsAssignment_4_1 = (Assignment)cGroup_4.eContents().get(1);
		private final RuleCall cInBracketsMatrixAdditionInBracketsParserRuleCall_4_1_0 = (RuleCall)cInBracketsAssignment_4_1.eContents().get(0);
		
		//PrimaryMatrix returns MatrixExpression:
		//	{NewMatrix} matrix=Matrix | {TransposeMatrix} "[" name=MathName "]^T" | {MatrixVariable} "[" name=MathName "]" | "("
		//	MatrixAddition ")" | {MatrixInBrackets} inBrackets=MatrixAdditionInBrackets;
		public ParserRule getRule() { return rule; }
		...
		//MathName
		public RuleCall getNameMathNameParserRuleCall_1_2_0() { return cNameMathNameParserRuleCall_1_2_0; }
		...
		//MathName
		public RuleCall getNameMathNameParserRuleCall_2_2_0() { return cNameMathNameParserRuleCall_2_2_0; }
		...
		//{MatrixInBrackets}
		public Action getMatrixInBracketsAction_4_0() { return cMatrixInBracketsAction_4_0; }

		//inBrackets=MatrixAdditionInBrackets
		public Assignment getInBracketsAssignment_4_1() { return cInBracketsAssignment_4_1; }

		//MatrixAdditionInBrackets
		public RuleCall getInBracketsMatrixAdditionInBracketsParserRuleCall_4_1_0() { return cInBracketsMatrixAdditionInBracketsParserRuleCall_4_1_0; }
	}
	...
	public class FunctionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cNameMathNameParserRuleCall_0_0 = (RuleCall)cNameAssignment_0.eContents().get(0);
		...
		//MathName
		public RuleCall getNameMathNameParserRuleCall_0_0() { return cNameMathNameParserRuleCall_0_0; }
	...
	public class MathNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MathName");
		private final Assignment cMathNameAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cMathNameMATH_NAMETerminalRuleCall_0 = (RuleCall)cMathNameAssignment.eContents().get(0);
		...
		//mathName=MATH_NAME
		public Assignment getMathNameAssignment() { return cMathNameAssignment; }

		//MATH_NAME
		public RuleCall getMathNameMATH_NAMETerminalRuleCall_0() { return cMathNameMATH_NAMETerminalRuleCall_0; }
	}
	...
	private AdditionInBracketsElements pAdditionInBrackets;
	...
	private MatrixAdditionInBracketsElements pMatrixAdditionInBrackets;
	...
	private MathNameElements pMathName;
	...
	@Inject
	public MexGrammarAccess(GrammarProvider grammarProvider,
	...
	//AdditionInBrackets returns Expression:
	//	"(" addition=Addition ")";
	public AdditionInBracketsElements getAdditionInBracketsAccess() {
		return (pAdditionInBrackets != null) ? pAdditionInBrackets : (pAdditionInBrackets = new AdditionInBracketsElements());
	}
	
	public ParserRule getAdditionInBracketsRule() {
		return getAdditionInBracketsAccess().getRule();
	}
	...
	//MatrixAdditionInBrackets returns MatrixExpression:
	//	"(" addition=MatrixAddition ")";
	public MatrixAdditionInBracketsElements getMatrixAdditionInBracketsAccess() {
		return (pMatrixAdditionInBrackets != null) ? pMatrixAdditionInBrackets : (pMatrixAdditionInBrackets = new MatrixAdditionInBracketsElements());
	}
	
	public ParserRule getMatrixAdditionInBracketsRule() {
		return getMatrixAdditionInBracketsAccess().getRule();
	}
	...
	//MathName:
	//	mathName=MATH_NAME;
	public MathNameElements getMathNameAccess() {
		return (pMathName != null) ? pMathName : (pMathName = new MathNameElements());
	}
	
	public ParserRule getMathNameRule() {
		return getMathNameAccess().getRule();
	}
