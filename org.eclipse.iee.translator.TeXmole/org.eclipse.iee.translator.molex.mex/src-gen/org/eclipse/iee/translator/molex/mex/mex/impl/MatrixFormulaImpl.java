 ...
 * <ul>
 *   <li>{@link org.eclipse.iee.translator.molex.mex.mex.impl.MatrixFormulaImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MatrixFormulaImpl extends MinimalEObjectImpl.Container implements MatrixFormula
{
  ...
  {
    return MexPackage.Literals.MATRIX_FORMULA;
  }
  ...
  public NotificationChain basicSetExpression(MatrixExpression newExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MexPackage.MATRIX_FORMULA__EXPRESSION, oldExpression, newExpression);
  ...
  public void setExpression(MatrixExpression newExpression)
  {
    if (newExpression != expression)
    {
      ...
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MexPackage.MATRIX_FORMULA__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MexPackage.MATRIX_FORMULA__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MexPackage.MATRIX_FORMULA__EXPRESSION, newExpression, newExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MexPackage.MATRIX_FORMULA__EXPRESSION:
