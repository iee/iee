 ...
 * <ul>
 *   <li>{@link org.eclipse.iee.translator.molex.mex.mex.impl.NewMatrixImpl#getMatrix <em>Matrix</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NewMatrixImpl extends MatrixExpressionImpl implements NewMatrix
{
  ...
  {
    return MexPackage.Literals.NEW_MATRIX;
  }
  ...
  public NotificationChain basicSetMatrix(Matrix newMatrix, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MexPackage.NEW_MATRIX__MATRIX, oldMatrix, newMatrix);
  ...
  public void setMatrix(Matrix newMatrix)
  {
    if (newMatrix != matrix)
    {
      ...
      if (matrix != null)
        msgs = ((InternalEObject)matrix).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MexPackage.NEW_MATRIX__MATRIX, null, msgs);
      if (newMatrix != null)
        msgs = ((InternalEObject)newMatrix).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MexPackage.NEW_MATRIX__MATRIX, null, msgs);
      msgs = basicSetMatrix(newMatrix, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MexPackage.NEW_MATRIX__MATRIX, newMatrix, newMatrix));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MexPackage.NEW_MATRIX__MATRIX:
