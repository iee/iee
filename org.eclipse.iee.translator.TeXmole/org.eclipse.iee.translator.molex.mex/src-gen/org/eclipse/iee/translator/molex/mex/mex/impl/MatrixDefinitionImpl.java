 ...
 * <ul>
 *   <li>{@link org.eclipse.iee.translator.molex.mex.mex.impl.MatrixDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.iee.translator.molex.mex.mex.impl.MatrixDefinitionImpl#getRows <em>Rows</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MatrixDefinitionImpl extends MinimalEObjectImpl.Container implements MatrixDefinition
{
  ...
  {
    return MexPackage.Literals.MATRIX_DEFINITION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MexPackage.MATRIX_DEFINITION__NAME, oldName, name));
  }
  ...
  public EList<MatrixRow> getRows()
  {
    if (rows == null)
    {
      rows = new EObjectContainmentEList<MatrixRow>(MatrixRow.class, this, MexPackage.MATRIX_DEFINITION__ROWS);
    }
    return rows;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MexPackage.MATRIX_DEFINITION__ROWS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MexPackage.MATRIX_DEFINITION__NAME:
        return getName();
      case MexPackage.MATRIX_DEFINITION__ROWS:
        return getRows();
    }
