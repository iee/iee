...
public class MathFactoryImpl extends EFactoryImpl implements MathFactory
{
  ...
  public static MathFactory init()
  {
    try
    {
      MathFactory theMathFactory = (MathFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/iee/translator/molex/math/Math"); 
   ...
   * @generated
   */
  public org.eclipse.iee.translator.molex.math.math.Float createFloat()
  {
