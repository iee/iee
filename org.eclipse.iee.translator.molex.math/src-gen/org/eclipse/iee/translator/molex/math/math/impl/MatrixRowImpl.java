 ...
 * <ul>
 *   <li>{@link org.eclipse.iee.translator.molex.math.math.impl.MatrixRowImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MatrixRowImpl extends MinimalEObjectImpl.Container implements MatrixRow
{
  ...
  public EList<String> getElements()
  {
    if (elements == null)
    {
      elements = new EDataTypeEList<String>(String.class, this, MathPackage.MATRIX_ROW__ELEMENTS);
    }
    return elements;
  }
