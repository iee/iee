 ...
 * <ul>
 *   <li>{@link org.eclipse.iee.translator.molex.math.math.Interval#getOpeningBracket <em>Opening Bracket</em>}</li>
 *   <li>{@link org.eclipse.iee.translator.molex.math.math.Interval#getCeil <em>Ceil</em>}</li>
 *   <li>{@link org.eclipse.iee.translator.molex.math.math.Interval#getFloor <em>Floor</em>}</li>
 *   <li>{@link org.eclipse.iee.translator.molex.math.math.Interval#getClosingBracket <em>Closing Bracket</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.iee.translator.molex.math.math.MathPackage#getInterval()
 * @model
 * @generated
 */
public interface Interval extends Expression
{
   ...
   * @see org.eclipse.iee.translator.molex.math.math.MathPackage#getInterval_OpeningBracket()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.iee.translator.molex.math.math.Interval#getOpeningBracket <em>Opening Bracket</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.iee.translator.molex.math.math.MathPackage#getInterval_Ceil()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.iee.translator.molex.math.math.Interval#getCeil <em>Ceil</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.iee.translator.molex.math.math.MathPackage#getInterval_Floor()
   * @model containment="true"
   * @generated
   */
  Expression getFloor();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.iee.translator.molex.math.math.Interval#getFloor <em>Floor</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.iee.translator.molex.math.math.MathPackage#getInterval_ClosingBracket()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.iee.translator.molex.math.math.Interval#getClosingBracket <em>Closing Bracket</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
