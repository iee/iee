package org.eclipse.iee.translator.molex.math.serializer;
...
public class AbstractMathSemanticSequencer extends AbstractSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == MathPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case MathPackage.FLOAT:
				if(context == grammarAccess.getAdditionRule() ||
				   ...
				   context == grammarAccess.getPrimaryRule() ||
				   context == grammarAccess.getUnaryExpressionRule()) {
					sequence_Primary(context, (org.eclipse.iee.translator.molex.math.math.Float) semanticObject); 
					return; 
				}
				else break;
	 ...
	 *    value[1, 1]
	 */
	protected void sequence_Primary(EObject context, org.eclipse.iee.translator.molex.math.math.Float semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
