 ...
 * <ul>
 *   <li>{@link org.eclipse.iee.translator.jmole.math.math.impl.MatrixRowImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MatrixRowImpl extends MinimalEObjectImpl.Container implements MatrixRow
{
  ...
  {
    return MathPackage.Literals.MATRIX_ROW;
  }
  ...
  public EList<Formula> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Formula>(Formula.class, this, MathPackage.MATRIX_ROW__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MathPackage.MATRIX_ROW__ELEMENTS:
