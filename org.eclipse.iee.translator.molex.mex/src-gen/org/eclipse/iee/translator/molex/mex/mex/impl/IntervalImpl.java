 ...
 * <ul>
 *   <li>{@link org.eclipse.iee.translator.molex.mex.mex.impl.IntervalImpl#getOpeningBracket <em>Opening Bracket</em>}</li>
 *   <li>{@link org.eclipse.iee.translator.molex.mex.mex.impl.IntervalImpl#getCeil <em>Ceil</em>}</li>
 *   <li>{@link org.eclipse.iee.translator.molex.mex.mex.impl.IntervalImpl#getFloor <em>Floor</em>}</li>
 *   <li>{@link org.eclipse.iee.translator.molex.mex.mex.impl.IntervalImpl#getClosingBracket <em>Closing Bracket</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntervalImpl extends ExpressionImpl implements Interval
{
  ...
  {
    return MexPackage.Literals.INTERVAL;
  }
  ...
  public void setOpeningBracket(String newOpeningBracket)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MexPackage.INTERVAL__OPENING_BRACKET, oldOpeningBracket, openingBracket));
  }
  ...
  public NotificationChain basicSetCeil(Expression newCeil, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MexPackage.INTERVAL__CEIL, oldCeil, newCeil);
  ...
  public void setCeil(Expression newCeil)
  {
    if (newCeil != ceil)
    {
      ...
      if (ceil != null)
        msgs = ((InternalEObject)ceil).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MexPackage.INTERVAL__CEIL, null, msgs);
      if (newCeil != null)
        msgs = ((InternalEObject)newCeil).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MexPackage.INTERVAL__CEIL, null, msgs);
      msgs = basicSetCeil(newCeil, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MexPackage.INTERVAL__CEIL, newCeil, newCeil));
  }
  ...
  public NotificationChain basicSetFloor(Expression newFloor, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MexPackage.INTERVAL__FLOOR, oldFloor, newFloor);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setFloor(Expression newFloor)
  {
    if (newFloor != floor)
    {
      NotificationChain msgs = null;
      if (floor != null)
        msgs = ((InternalEObject)floor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MexPackage.INTERVAL__FLOOR, null, msgs);
      if (newFloor != null)
        msgs = ((InternalEObject)newFloor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MexPackage.INTERVAL__FLOOR, null, msgs);
      msgs = basicSetFloor(newFloor, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MexPackage.INTERVAL__FLOOR, newFloor, newFloor));
  }
  ...
  public void setClosingBracket(String newClosingBracket)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MexPackage.INTERVAL__CLOSING_BRACKET, oldClosingBracket, closingBracket));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MexPackage.INTERVAL__CEIL:
        return basicSetCeil(null, msgs);
      case MexPackage.INTERVAL__FLOOR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MexPackage.INTERVAL__OPENING_BRACKET:
        return getOpeningBracket();
      case MexPackage.INTERVAL__CEIL:
        return getCeil();
      case MexPackage.INTERVAL__FLOOR:
        return getFloor();
      case MexPackage.INTERVAL__CLOSING_BRACKET:
